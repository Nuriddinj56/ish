                        ...
                        <tr>
                            <td class="legendColorBox">
                                <div style="border:1px solid #ccc;padding:1px">
                                    <div style="width:4px;height:0;border:5px solid rgba(220,220,220,1);overflow:hidden"></div>
                                </div>
                            </td>
                            <td class="legendLabel">
                                &nbsp;&nbsp;<?= Yii::t("app", "Number of successful requests"); ?>
                            </td>
                        </tr>
                        <tr>
                            <td class="legendColorBox">
                            ...
                            <td class="legendLabel">
                                &nbsp;&nbsp;<?= Yii::t("app", "Number of failed requests"); ?>
                            </td>
                        </tr>
