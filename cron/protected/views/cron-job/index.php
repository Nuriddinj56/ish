    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                ...
                <a href="<?php echo Url::to(["create"]) ?>" class="btn btn-large btn-primary pull-right"><?php echo Yii::t("app", "Create New Cron Job") ?></a>
                <a href="<?php echo Url::to(["index"]) ?>" class="btn btn-large btn-default pull-right" style="margin-right: 20px"><?php echo Yii::t("app", "Clear filter") ?></a>
            </div>
            <div class="box-body">
