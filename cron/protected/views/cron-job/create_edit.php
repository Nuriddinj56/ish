            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_general">
                    ...
                    <div class="form-group<?php echo $model->hasErrors("url") ? ' has-error' : null ?>">
                        <label for="schedule-url" class="col-sm-2 control-label"><?php echo Yii::t("app", "URL"); ?></label>
                        <div class="col-sm-4">
                    ...
                    <br>
                    <h4 class="col-sm-offset-2"><?= Yii::t("app", "HTTP Basic Authorization") ?></h4>
                    <hr>
                    ...
                    <br>
                    <h4 class="col-sm-offset-2"><?= Yii::t("app", "Terminate") ?></h4>
                    <hr>
