...
$requirements = array(
    ...
    array(
        ...
        (ini_get('short_open_tag') == 'Off' || ini_get('short_open_tag')=='0'),
    ...
    array(
        ...
        'PHP mail SMTP server required. Email sending.',
    ),
);
...
<head>
    ...
    <title>Online Cronjobs Manager Requirements Checker</title>
    <style type="text/css">
        body
        {
            background: white;
