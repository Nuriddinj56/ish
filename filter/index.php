...
<body>
	...
	<div class="col-md-6 well">
		...
		<form class="form-inline" method="POST" action="">
			<label>Date:</label>
			<input type="datetime-local" class="form-control" placeholder="Start"  name="date1" value="<?php echo isset($_POST['date1']) ? $_POST['date1'] : '' ?>" />
			<label>To</label>
			<input type="datetime-local" class="form-control" placeholder="End"  name="date2" value="<?php echo isset($_POST['date2']) ? $_POST['date2'] : '' ?>"/>
