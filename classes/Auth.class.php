...
class User
{
    ...
    private $db_name = "orion";
    private $db_user = "orion";
    private $db_pass = "пароль от бд";
    ...
    public function getSalt($username) {
        $query = "select salt from dle_users where username = :username limit 1";
    ...
    {
        $query = "select id, username from dle_users where
    ...
    public function create($username, $password) {
        ...
        $query = "insert into dle_users (username, password, salt)
